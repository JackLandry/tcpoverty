...
```{r, include = FALSE}
#Need to be careful, this is not a cleaned I
ipum <- ipum %>% mutate(total_income=ifelse(inctot==999999999,NA,inctot),
                        income_percentile=ntile(total_income,100)) #This is individual level income? when maybe I want family unit level
