...
```
This seems implausible if I understand that changes I made to the EITC correctly. I seem to have an issue with non-matches in the tax data who have 0 income change. Don't think this can be explained by nonfiling, though I do need to figure out how that is handled.
```{r, echo=FALSE, fig.align="center"}
income_percentile_change_plot
```

Should do analysis for different groups, e.g. number of children, labor force status, race, more?
